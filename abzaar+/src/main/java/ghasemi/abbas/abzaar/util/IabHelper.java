...
package ghasemi.abbas.abzaar.util;
...
import static ghasemi.abbas.abzaar.BuildVars.getIntentMarket;
...
public class IabHelper {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        ...
        Intent serviceIntent = new Intent(getIntentMarket()+".InAppBillingService.BIND");
        serviceIntent.setPackage(getPackageMarket());
