 ...
 */
package ghasemi.abbas.abzaar.db.barcode.b;
...
import ghasemi.abbas.abzaar.db.barcode.a.BarcodeFragment;
import ghasemi.abbas.abzaar.db.barcode.b.camera.CameraSource;
import ghasemi.abbas.abzaar.db.barcode.b.camera.CameraSourcePreview;
import ghasemi.abbas.abzaar.db.barcode.b.camera.GraphicOverlay;
...
public final class BarcodeCapture extends BarcodeFragment {
    ...
    private void createCameraSource(Detector<Barcode> barcodeDetector, boolean autoFocus, boolean useFlash) {
        ...
        if (!barcodeDetector.isOperational()) {
            ...
            if (hasLowStorage) {
                ToastActivity.Toast(getContext(),"Face detector dependencies cannot be downloaded due to low device storage",Toast.LENGTH_SHORT);
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        barcodeRetriever.onRetrievedFailed("دسترسی های لازم به برنامه داده نشده!");
