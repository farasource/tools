package ghasemi.abbas.abzaar.db.level.view;
...
import ghasemi.abbas.abzaar.db.level.orientation.Orientation;
...
public class LevelView extends View {
     ...
     * Fonts and colors
     */
    private static final String FONT_LCD = "fonts/sans.ttf";
